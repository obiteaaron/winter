...
public class RegisterCenterSpringAutoConfiguration {
    ...
    @Bean
    public RegisterService registerService(ConfigManager configManager, RegisterCenterProperties registerCenterProperties) {
        ...
        return new DefaultRegisterServiceImpl(configManager, registerCenterConfig);
    }
}